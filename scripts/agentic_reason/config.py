...
def parse_args():
    ...
    model_group.add_argument(
        '--remote_model',
        type=str,
        choices=['gpt-4o', 'claude-3.5-sonnet', 'deepseek-v3.2'],
        help="Name of remote API-based model to use (OpenAI's GPT-4o or Anthropic's Claude models or Deepseek models)."
    )
